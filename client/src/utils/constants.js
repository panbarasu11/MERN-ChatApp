...
export const EMAIL_VERIFICATION_ROUTE = `${AUTH_ROUTES}/verify-email`;
...
// export const UNREAD_MESSAGES_ROUTE = `${MESSAGES_ROUTES}/unread-count`;
...
export const FEEDBACK_ROUTES = "api/feedback";
export const SUBMIT_FEEDBACK_ROUTES = `${FEEDBACK_ROUTES}/submit`;
