      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div
                className="absolute top-[3.4rem] inset-0 flex items-center justify-center bg-black/50 ring-black/50 ring-fuchsia-50 rounded-full h-32 w-32 md:h-48 md:w-48 md:top-[1.4rem]"
