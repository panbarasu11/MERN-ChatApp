...
const MessageBar = () => {
  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter") {
      e.preventDefault(); // Prevents the default Enter behavior (e.g., submitting a form)
      handleSendMessage();
    }
  };
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-8 gap-8">
